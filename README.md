...
Publishing to MQTT and Printing to UART:
...
The mySerial object is defined using HardwareSerial(1) to use the second hardware serial port (UART1) on the ESP32.
The mySerial.begin(9600, SERIAL_8N1, 17, 16) initializes the serial communication with a baud rate of 9600 on pins 17 (RX) and 16 (TX).
